...
Module Completed
    ...
    Sub New()
        ...
        End Try
    End Sub
    Sub completed(approved As String, completed As String, selectedDocumentId As String)
        ...
        Dim destCollection As IMongoCollection(Of BsonDocument) = database.GetCollection(Of BsonDocument)(completed)
