...
Public Class delete
    ...
    Private Sub delete_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        End If
    End Sub
    Private Sub FetchDoctorData1(clientsId As String, collectionName As String)
    ...
    Private Sub BtnSave_Click(sender As Object, e As EventArgs) Handles BtnSave.Click
        Dim sourceCollectionName As String = "rejected"
        Dim destCollectionName As String = "deleted"


        ' Call the MoveCollectionData function from the MongoDBHelper module
        deleted.canceled(sourceCollectionName, destCollectionName, CompleteId)
